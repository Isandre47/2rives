...
function initClient() {
    ...
    gapi.client.init({
        'clientId': '183588707044-bcpp2j7kf5rlqim6fsbbpv5cko33l2ur.apps.googleusercontent.com',
...
function defineRequest() {
    var metadata = createResource({'snippet.categoryId': '22',
        ...
        'snippet.description': $('#description').text(),
        'snippet.tags[]': '',
        'snippet.title': $('#title').val(),
        'status.embeddable': '',
        'status.license': '',
        'status.privacyStatus': $('#privacy-status:selected').text(),
    ...
    var uploader = new MediaUploader({
        ...
        onProgress: function(data) {
            ...
            console.log('uploadstart: ' + this.uploadStartTime);
            var totalBytes = data.total;
        }.bind(this),
        onComplete: function(data) {
            var uploadResponse = JSON.parse(data);
            var id = uploadResponse.id;
            sessionStorage.setItem('bodyresp', id);
